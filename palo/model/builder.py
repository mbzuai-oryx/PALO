...
from palo.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False,
    ...
    if 'palo' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            print('Loading palo from base model...')
            model = PaloForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
            ...
            print('Loading additional palo weights...')
            ...
            if 'mpt' in model_name.lower():
                ...
                model = PaloForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained,
                                                              **kwargs)
            ...
            if 'mpt' in model_name.lower():
                ...
                model = PaloForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
    else:
        # Load language model
