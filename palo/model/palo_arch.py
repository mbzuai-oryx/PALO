...
from palo.constants import (IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN,
...
class PaloMetaModel:
    ...
    def __init__(self, config):
        super(PaloMetaModel, self).__init__(config)
